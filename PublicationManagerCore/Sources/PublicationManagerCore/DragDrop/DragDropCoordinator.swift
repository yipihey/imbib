...
public final class DragDropCoordinator: ObservableObject {
    ...
    public init(
        fileDropHandler: FileDropHandler = .init(),
        pdfImportHandler: PDFImportHandler = .shared,
        bibDropHandler: BibDropHandler = .shared
    ) {
        self.fileDropHandler = fileDropHandler
        self.pdfImportHandler = pdfImportHandler
        self.bibDropHandler = bibDropHandler
    }
