...
| Identifiers | OpenAlex ID, DOI |

**Normalization**:
- Map OpenAlex concepts to keywords
...
- Excellent coverage (200M+ works)
- Rich metadata including affiliations, concepts, open access info
- Just needs email for polite pool (higher rate limits)
