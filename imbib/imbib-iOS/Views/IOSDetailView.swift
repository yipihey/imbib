...
/// iOS detail view showing publication information.
///
/// This wraps the shared UnifiedDetailView from the Core package with iOS-specific
/// navigation and toolbar handling.
struct DetailView: View {
    ...
    /// Venue from journal, booktitle, or publisher field
